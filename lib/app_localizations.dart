...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    ...
    'ar': {
      ...
      'remember_me': 'Remember Me', 'forgot_pin': 'Forgot PIN?', 'login_btn': 'Login', 'create_account_btn': 'Create Account & Enter', 'create_account': 'Create Account', 'biometric_login': 'Biometric Login', 'last_login': 'Last Successful Login', 'pin_recovery': 'PIN Recovery', 'pin_recovery_msg': 'Contact admin or teacher to reset your PIN.', 'ok': 'OK', 'account_created': 'Account registered successfully!', 'error_phone_pin': 'Please enter phone number and PIN', 'error_name_required': 'Please enter your full name', 'error_phone_invalid': 'Please enter a valid phone number', 'error_pin_short': 'PIN must be at least 4 digits', 'error_pin_mismatch': 'PIN confirmation does not match', 'error_wrong_pin': 'Wrong phone number or PIN', 'attempts_remaining': 'Attempts remaining', 'security_lock': 'Security Lock', 'seconds_remaining': 'seconds remaining', 'too_many_attempts': 'Too many failed attempts!', 'staff_attendance': 'Staff Attendance', 'staff_attendance_saved': 'Staff Attendance Saved', 'expenses': 'Income & Expenses', 'substitute_teacher': 'Substitute Teacher Duty', 'substitute_desc': 'Assign substitute for absent teacher', 'dropout_analytics': 'Dropout Register', 'reason': 'Reason', 'audit_log': 'Admin History & Logs', 'select_branch': 'Select Branch', 'backup_desc': 'Backup or restore all data', 'class_promotion': 'Class Promotion', 'promote_confirm': 'Promote all students to next class?', 'promote_all': 'Promote All', 'students_promoted': 'All students promoted to next class', 'leaving_cert': 'Leaving Certificate', 'add_expense': 'Add Expense', 'substitute_duty': 'Substitute Duty', 'code_of_conduct': 'Code of Conduct', 'rule_punctuality': 'Punctuality is mandatory', 'rule_dress': 'Come in clean dress with cap', 'rule_absence': '3 consecutive absences may cancel admission', 'rule_fee': 'Submit fee by 10th of each month', 'role_permissions': 'Role-Based Permissions', 'admin_full_access': 'Admin: Full Access', 'manager_fees_results': 'Manager: Fees & Results', 'teacher_attendance_dars': 'Teacher: Attendance & Dars', 'mutawalli_finance': 'Mutawalli: Financial Auditor', 'digital_id_card': 'Digital ID Card', 'position': 'Position', 'new_admissions': 'New Admissions', 'old_admissions': 'Old Admissions', 'hifz_group': 'Hifz Group', 'nazira_group': 'Nazira Group', 'tajweed_group': 'Tajweed Group', 'primary_group': 'Primary Group', 'morning_shift': 'Morning', 'evening_shift': 'Evening', 'good_morning': 'Good Morning', 'good_afternoon': 'Good Afternoon', 'good_evening': 'Good Evening', 'dashboard': 'Dashboard', 'settings': 'Settings', 'logout': 'Logout', 'about': 'About App', 'version': 'Version', 'search': 'Search', 'close': 'Close', 'admin_login': 'Admin Login', 'manager_login': 'Manager Login', 'teacher_login': 'Teacher Login', 'parent_login': 'Parent Login', 'mutawalli_login': 'Mutawalli Login', 'user_login': 'User Login', 'role_tier': 'Tier',
    },
